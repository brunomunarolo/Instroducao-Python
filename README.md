...
6 - Após fechar o instalador
   ...
   - Aperte Windows + R e escreva dentro do terminal "python".
...
- Os nomes das variáveis diferenciam maiúsculas de minúsculas (idade, idade e AGE são três variáveis diferentes)
